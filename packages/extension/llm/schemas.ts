...
export const ChatMessageImageContentSchema = z.toZod<ChatMessageImageContent>()(
  z.union([
    z
      .object({
...
export const ChatMessageTextContentSchema = z.toZod<ChatMessageTextContent>()(
  z
    .object({
      type: z.literal("text"),
      text: z.string(),
...
export const ChatMessageContentSchema = z.toZod<ChatMessageContent>()(
  z.union([
    z.string(),
...
export const ChatMessageSchema = z.toZod<ChatMessage>()(
  z
    .object({
...
export const LLMResponseSchema = z.toZod<LLMResponse>()(
  z
    .object({
      id: z.string(),
      object: z.string(),
...
export const LLMUsageSchema = z.toZod<LLMUsage>()(
  z
    .object({
      prompt_tokens: z.number(),
      completion_tokens: z.number(),
...
export const LLMParsedResponseSchema = z.toZod<LLMParsedResponse<unknown>>()(
  z
    .object({
